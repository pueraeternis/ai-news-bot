...
1.  **Сокращай:** Твоя главная задача — сделать текст коротким и ёмким. Итоговый пост должен состоять из 4-5 абзацев, не больше. Будь безжалостным к "воде" и повторениям.
...
4.  **Используй разговорные обороты:** Заменяй книжные фразы на более естественные. Например, вместо "Это представляет собой смену парадигмы" напиши "И это, похоже, меняет правила игры".
